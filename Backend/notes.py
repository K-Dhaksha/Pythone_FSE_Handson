...
A Django project is the complete web application and contains the overall configuration,
 such as settings and URL routing. 
 A Django app is a self-contained module that
 implements a specific feature (such as courses or students)
 with its own models, views, and URLs. 
